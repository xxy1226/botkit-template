...
module.exports = function (controller) {
    ...
    controller.hears([/^help$/], 'direct_message,direct_mention', function (bot, message) {
        ...
        text += "\n- " + bot.appendMention(message, "quiz") + ": Want to challenge yourself?";
        text += "\n- " + bot.appendMention(message, "ea") + ": Looking for an Educational Assistant?";
        text += "\n- " + bot.appendMention(message, "instructor") + ": Looking for an Instructor?";
